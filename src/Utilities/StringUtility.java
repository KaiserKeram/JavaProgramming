...
import day16_ForLoopStringPrectice.Palindrome;
...
public class StringUtility {
    ...
    //remove the duplicates from given string, return string. "aaaaabbbbbcccc" ===>"abc"

    public static String removeDuplicates(String str){

        String result = "";
        for (int i = 0; i < str.length(); i++) {
            char each = str.charAt(i); //aaaaabbbbbbbcccc
