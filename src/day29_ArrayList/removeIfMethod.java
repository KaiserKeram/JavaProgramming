...
public class removeIfMethod {
    ...
    public static void main(String[] args) {
        ...
        removeAll(): when you want to remove multiple elements.(If the elements that we want to remove are known)
        retainAll(): when you want to keep the multiple elements(If the elements that we want to retain are known)
